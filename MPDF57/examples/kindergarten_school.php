...
<td width="50%"> '.foreign_value('where regime__de__gestion_id="'.foreign_value('where identitification__pre__primaire_id="'.$_GET['id'].'"',$table,14,$db).'"','tbl__11regime__de__gestion',2,$db).'/'.foreign_value('where 	sous__regime__de__gestion_id="'.foreign_value('where identitification__pre__primaire_id="'.$_GET['id'].'"',$table,15,$db).'"','tbl__64sous__regime__de__gestion',3,$db).'</td>
</tr>
<tr>
...
<td width="50%"> '.foreign_value('where statut__d666ocupation_id="'.foreign_value('where identitification__pre__primaire_id="'.$_GET['id'].'"',$table,19,$db).'"','tbl__13statut__d666ocupation',2,$db).'</td>
</tr>
<tr>
