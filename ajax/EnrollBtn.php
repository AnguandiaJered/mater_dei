...
{
echo '<a href="inscription_popup.php?class=17&ref_id=default&ref_menu=default&num_mat='.$num_mat.'&section_id='.$_REQUEST['section_id'].'&option_id='.$_REQUEST['option_id'].'&classe_id='.$_REQUEST['classe_id'].'&id='.$_REQUEST['id'].'&action='.$_REQUEST['action'].'" rel="facebox"><button type="button">Inscrire</button></a>';
}else
{
