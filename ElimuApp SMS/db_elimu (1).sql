...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 15 sep. 2017 à 16:51
...
--
-- Base de données :  `db_elimu`
--
CREATE DATABASE IF NOT EXISTS `db_elimu` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_elimu`;

-- --------------------------------------------------------

--
-- Structure de la table `tbl__01foreign__keys`
--

CREATE TABLE `tbl__01foreign__keys` (
...
--
-- Déchargement des données de la table `tbl__01foreign__keys`
--
...
(11, 'frais__carrefour_id', 80, 1);

-- --------------------------------------------------------

--
-- Structure de la table `tbl__02utilisateurs`
--

CREATE TABLE `tbl__02utilisateurs` (
...
--
-- Déchargement des données de la table `tbl__02utilisateurs`
--
...
(11, 'guy', 'naledi', 'caissier_entree', 'GUILLAIN ', 'BSISMWA', 'Masculin', '<img src=\"#_srcdata_buddle/5517_File_12.jpg\" width=\"#_width\" height=\"#_height\">');

-- --------------------------------------------------------

--
-- Structure de la table `tbl__03configuration`
--

CREATE TABLE `tbl__03configuration` (
...
--
-- Déchargement des données de la table `tbl__03configuration`
--
...
(2, 'Job Advertiser', 'info@odhasbl.org', '000000000000000000', 'Goma', 'Others...', 'Elimu App', 'Sowebgra', 'This Application is all about managing Job Advertiser', 200, 150, '<img src=\"#_srcdata_buddle/5877_File_logo3.png\" width=\"#_width\" height=\"#_height\">', 10, 5, 'Copyright Job Advertiser');

-- --------------------------------------------------------

--
-- Structure de la table `tbl__04customize__tabform`
--

CREATE TABLE `tbl__04customize__tabform` (
  `tabform_id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl__05table__fields`
--

CREATE TABLE `tbl__05table__fields` (
...
--
-- Structure de la table `tbl__06input__objects`
--

CREATE TABLE `tbl__06input__objects` (
  `input__object_id` int(11) NOT NULL,
  `input__object` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__06input__objects`
--
...
--
-- Structure de la table `tbl__07dropdownlist`
--

CREATE TABLE `tbl__07dropdownlist` (
  `dropdownlist_id` int(11) NOT NULL,
  `table__field_id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl__08dropdownlist__group`
--

CREATE TABLE `tbl__08dropdownlist__group` (
  `dropdownlistgroup_id` int(11) NOT NULL,
  `table__field_id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl__09type__de__gestion`
--

CREATE TABLE `tbl__09type__de__gestion` (
  `type__de__gestion_id` int(11) NOT NULL,
  `type__de__gestion` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__09type__de__gestion`
--
...
--
-- Structure de la table `tbl__10institution`
--

CREATE TABLE `tbl__10institution` (
...
--
-- Déchargement des données de la table `tbl__10institution`
--
...
--
-- Structure de la table `tbl__11section`
--

CREATE TABLE `tbl__11section` (
  `section_id` int(11) NOT NULL,
  `section` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__11section`
--
...
--
-- Structure de la table `tbl__12enseignants`
--

CREATE TABLE `tbl__12enseignants` (
...
--
-- Déchargement des données de la table `tbl__12enseignants`
--
...
--
-- Structure de la table `tbl__13cours`
--

CREATE TABLE `tbl__13cours` (
...
--
-- Déchargement des données de la table `tbl__13cours`
--
...
--
-- Structure de la table `tbl__14frais__scolaires`
--

CREATE TABLE `tbl__14frais__scolaires` (
...
--
-- Déchargement des données de la table `tbl__14frais__scolaires`
--
...
--
-- Structure de la table `tbl__15classe`
--

CREATE TABLE `tbl__15classe` (
  `classe_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `tbl__15classe`
--
...
--
-- Structure de la table `tbl__16conduite`
--

CREATE TABLE `tbl__16conduite` (
  `conduite_id` int(11) NOT NULL,
  `conduite` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__16conduite`
--
...
--
-- Structure de la table `tbl__17inscription__des__eleves`
--

CREATE TABLE `tbl__17inscription__des__eleves` (
...
(665, 'gust', 'tave', '20/10/2014', 'Feminin', '', '', '', '', '', '', 2, 4, 18, '000169/1bP/2016-2017', '<img src=\"#_srcdata_buddle/7160_File_1.jpg\" width=\"#_width\" height=\"#_height\">', '', '', ''),
(666, 'gloria', 'rimarnee', '20/10/2014', 'Feminin', 'ep sofia', '5', '76', 'b', 'goma', 'guy', 2, 6, 25, '000067/5P/2016-2017', '<img src=\"#_srcdata_buddle/9250_File_121465557.png\" width=\"#_width\" height=\"#_height\">', '', '+243978532756', 'buss'),
(667, '', '', '', '', '', '', '', '', '', '', 1, 3, 10, '000277/1aM/2016-2017', '', '', '', ''),
(668, 'gustavi mokole', 'Goma', '20/10/2014', 'Masculin', '', '', '', '', '', 'fiston', 1, 3, 10, '000278/1aM/2016-2017', '<img src=\"#_srcdata_buddle/4140_File_2.jpg\" width=\"#_width\" height=\"#_height\">', '', '+243978532756', 'bus'),
(669, 'yes we can', 'goma', '20/10/2014', 'Masculin', 'usa', '4', '56', 'b', 'usa nevada', 'guyl', 2, 6, 25, '000068/5P/2016-2017', '<img src=\"#_srcdata_buddle/5607_File_blogger-128.png\" width=\"#_width\" height=\"#_height\">', '', '+243978532756', 'avions'),
(670, 'zaho laisser parler', 'paris', '20/10/2014', 'Feminin', 'musuiv', '4', '67', 'b', 'paris sg', 'gyui', 2, 6, 25, '000069/5P/2016-2017', '', '', '978532756', 'train'),
(671, 'kerry james', '', '', '', '', '', '', '', '', '', 2, 6, 25, '000070/5P/2016-2017', '', '<img src=\"#_srcdata_buddle/5310_File_youtube-128.png\" width=\"#_width\" height=\"#_height\">', '', ''),
(672, 'justin biebeer', '', '', 'Masculin', '', '', '', '', '', '', 2, 6, 25, '000071/5P/2016-2017', '<img src=\"#_srcdata_buddle/3740_File_baidu.png\" width=\"#_width\" height=\"#_height\">', '', '', ''),
(673, 'ji nilsson', '', '', 'Masculin', '', '', '', '', '', '', 2, 6, 25, '000072/5P/2016-2017', '', '<img src=\"#_srcdata_buddle/1937_File_google.png\" width=\"#_width\" height=\"#_height\">', '', ''),
(674, 'ji nilson remix', '', '', '', '', '', '', '', '', '', 2, 6, 25, '000073/5P/2016-2017', '', '<img src=\"#_srcdata_buddle/8984_File_yandex.png\" width=\"#_width\" height=\"#_height\">', '', ''),
(675, 'jul mal bareerr', '', '', 'Feminin', '', '', '', '', '', '', 2, 6, 26, '000074/6P/2016-2017', '', '<img src=\"#_srcdata_buddle/3042_File_Brazil.png\" width=\"#_width\" height=\"#_height\">', '', ''),
(676, 'ikibidi', '', '', '', '', '', '', '', '', '', 1, 3, 10, '000279/1aM/2016-2017', '', '<img src=\"#_srcdata_buddle/4280_File_China.png\" width=\"#_width\" height=\"#_height\">', '', ''),
(677, 'ikididi nouvelle', 'xxxx', '20/10/2014', 'Masculin', 'ffff', '3', '4', 'b', 'goma', 'guy', 2, 6, 26, '', '', '<img src=\"#_srcdata_buddle/5094_File_Italy.png\" width=\"#_width\" height=\"#_height\">', '0978532756', 'bus'),
(678, 'crhis brown', 'goma', '20/10/2014', 'Masculin', '', '', '', '', '', '', 2, 6, 25, '000076/5P/2016-2017', '<img src=\"#_srcdata_buddle/5308_File_Japan.png\" width=\"#_width\" height=\"#_height\">', '', '', ''),
(679, 'breezy', '', '', '', '', '', '', '', '', '', 2, 5, 23, '000146/4aP/2016-2017', '<img src=\"#_srcdata_buddle/8490_File_Nigeria.png\" width=\"#_width\" height=\"#_height\">', '', '', ''),
(680, 'puerto rico', '', '', '', '', '', '', '', '', '', 2, 5, 24, '000147/4bP/2016-2017', '<a href=\"#_srcdata_buddle/7451_File_Singapore.png\" target=\"_blank\"><button type=\"button\" class=\"btn btn-success\">Telecharger Fichier</button></a>', '', '', ''),
(681, 'Estelle jussie', 'newyork', '20/10/2014', 'Masculin', 'null', '5', '67', 'b', 'washington DC', 'empire cast', 2, 6, 26, '000077/6P/2016-2017', '<img src=\"#_srcdata_buddle/8336_File_2.jpg\" width=\"#_width\" height=\"#_height\">', '', '978532756', 'bus');

-- --------------------------------------------------------

--
-- Structure de la table `tbl__18gestion__des__cotes`
--

CREATE TABLE `tbl__18gestion__des__cotes` (
  `gestion__des__cotes_id` int(11) NOT NULL,
  `cours_id` int(11) NOT NULL,
  `enseignant_id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl__19qualification__grade`
--

CREATE TABLE `tbl__19qualification__grade` (
  `qualification__grade_id` int(11) NOT NULL,
  `qualification__grade` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__19qualification__grade`
--
...
--
-- Structure de la table `tbl__20option`
--

CREATE TABLE `tbl__20option` (
  `option_id` int(11) NOT NULL,
  `section_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `tbl__20option`
--
...
--
-- Structure de la table `tbl__21extra__utilisateur`
--

CREATE TABLE `tbl__21extra__utilisateur` (
  `user_id` int(11) NOT NULL,
  `compte__d666utilisateur` text NOT NULL,
  `mot__de__passe` text NOT NULL,
  `designation` text NOT NULL,
...
--
-- Déchargement des données de la table `tbl__21extra__utilisateur`
--
...
--
-- Structure de la table `tbl__22frais__scolaire`
--

CREATE TABLE `tbl__22frais__scolaire` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__23caisse`
--

CREATE TABLE `tbl__23caisse` (
  `caisse_id` int(11) NOT NULL,
  `caisse` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__23caisse`
--
...
--
-- Structure de la table `tbl__24banque`
--

CREATE TABLE `tbl__24banque` (
  `banque_id` int(11) NOT NULL,
  `banque` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__24banque`
--
...
--
-- Structure de la table `tbl__25type__de__compte`
--

CREATE TABLE `tbl__25type__de__compte` (
  `type__de__compte_id` int(11) NOT NULL,
  `type__de__compte` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__25type__de__compte`
--
...
--
-- Structure de la table `tbl__26compte`
--

CREATE TABLE `tbl__26compte` (
  `compte_id` int(11) NOT NULL,
  `type__de__compte_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `tbl__26compte`
--
...
--
-- Structure de la table `tbl__27payer__les__frais`
--

CREATE TABLE `tbl__27payer__les__frais` (
  `payer__les__frais_id` int(11) NOT NULL,
  `inscription__des__eleves_id` int(11) NOT NULL,
  `frais__scolaires_id` int(11) NOT NULL,
  `montant` text NOT NULL,
...
--
-- Déchargement des données de la table `tbl__27payer__les__frais`
--
...
--
-- Structure de la table `tbl__28recus`
--

CREATE TABLE `tbl__28recus` (
...
--
-- Déchargement des données de la table `tbl__28recus`
--
...
--
-- Structure de la table `tbl__29sortie`
--

CREATE TABLE `tbl__29sortie` (
...
--
-- Déchargement des données de la table `tbl__29sortie`
--
...
--
-- Structure de la table `tbl__30categorie`
--

CREATE TABLE `tbl__30categorie` (
  `categorie_id` int(11) NOT NULL,
  `categorie` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `tbl__30categorie`
--
...
--
-- Structure de la table `tbl__31perception__des__frais`
--

CREATE TABLE `tbl__31perception__des__frais` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__32solvabilite`
--

CREATE TABLE `tbl__32solvabilite` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__33entree`
--

CREATE TABLE `tbl__33entree` (
...
--
-- Déchargement des données de la table `tbl__33entree`
--
...
--
-- Structure de la table `tbl__34journal__caisse__ou__banque`
--

CREATE TABLE `tbl__34journal__caisse__ou__banque` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__35transfert`
--

CREATE TABLE `tbl__35transfert` (
...
--
-- Structure de la table `tbl__36liste__eleve`
--

CREATE TABLE `tbl__36liste__eleve` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__37point_eleve`
--

CREATE TABLE `tbl__37point_eleve` (
  `point_eleve_id` int(11) NOT NULL,
  `inscription__des__eleves_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `tbl__37point_eleve`
--
...
--
-- Structure de la table `tbl__38bulletins`
--

CREATE TABLE `tbl__38bulletins` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__39multiple__encodage__cours`
--

CREATE TABLE `tbl__39multiple__encodage__cours` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__40configuration__de__cours`
--

CREATE TABLE `tbl__40configuration__de__cours` (
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `tbl__41periodicite`
--

CREATE TABLE `tbl__41periodicite` (
  `periodecite_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `tbl__41periodicite`
--
...
--
-- Structure de la table `tbl__42activites`
--

CREATE TABLE `tbl__42activites` (
...
--
-- Déchargement des données de la table `tbl__42activites`
--
...
--
-- Structure de la table `tbl__43branches`
--

CREATE TABLE `tbl__43branches` (
...
--
-- Déchargement des données de la table `tbl__43branches`
--
...
--
-- Structure de la table `tbl__80frais__transport`
--

CREATE TABLE `tbl__80frais__transport` (
  `frais__carrefour_id` int(11) NOT NULL,
  `type__de__compte_id` int(11) NOT NULL,
  `compte_id` int(11) NOT NULL,
  `nom__du__frais` text NOT NULL,
  `montant` text NOT NULL
...
--
-- Index pour la table `tbl__01foreign__keys`
--
ALTER TABLE `tbl__01foreign__keys`
  ADD PRIMARY KEY (`fk_id`);

--
-- Index pour la table `tbl__02utilisateurs`
--
ALTER TABLE `tbl__02utilisateurs`
  ADD PRIMARY KEY (`user_id`);

--
-- Index pour la table `tbl__03configuration`
--
ALTER TABLE `tbl__03configuration`
  ADD PRIMARY KEY (`config_id`);

--
-- Index pour la table `tbl__04customize__tabform`
--
ALTER TABLE `tbl__04customize__tabform`
  ADD PRIMARY KEY (`tabform_id`);

--
-- Index pour la table `tbl__05table__fields`
--
ALTER TABLE `tbl__05table__fields`
  ADD PRIMARY KEY (`table__field_id`),
  ADD KEY `input__object_id` (`input__object_id`);

--
-- Index pour la table `tbl__06input__objects`
--
ALTER TABLE `tbl__06input__objects`
  ADD PRIMARY KEY (`input__object_id`);

--
-- Index pour la table `tbl__07dropdownlist`
--
ALTER TABLE `tbl__07dropdownlist`
  ADD PRIMARY KEY (`dropdownlist_id`);

--
-- Index pour la table `tbl__08dropdownlist__group`
--
ALTER TABLE `tbl__08dropdownlist__group`
  ADD PRIMARY KEY (`dropdownlistgroup_id`);

--
-- Index pour la table `tbl__09type__de__gestion`
--
ALTER TABLE `tbl__09type__de__gestion`
  ADD PRIMARY KEY (`type__de__gestion_id`);

--
-- Index pour la table `tbl__10institution`
--
ALTER TABLE `tbl__10institution`
  ADD PRIMARY KEY (`institution_id`);

--
-- Index pour la table `tbl__11section`
--
ALTER TABLE `tbl__11section`
  ADD PRIMARY KEY (`section_id`);

--
-- Index pour la table `tbl__12enseignants`
--
ALTER TABLE `tbl__12enseignants`
  ADD PRIMARY KEY (`enseignant_id`);

--
-- Index pour la table `tbl__13cours`
--
ALTER TABLE `tbl__13cours`
  ADD PRIMARY KEY (`cours_id`);

--
-- Index pour la table `tbl__14frais__scolaires`
--
ALTER TABLE `tbl__14frais__scolaires`
  ADD PRIMARY KEY (`frais__scolaires_id`);

--
-- Index pour la table `tbl__15classe`
--
ALTER TABLE `tbl__15classe`
  ADD PRIMARY KEY (`classe_id`);

--
-- Index pour la table `tbl__16conduite`
--
ALTER TABLE `tbl__16conduite`
  ADD PRIMARY KEY (`conduite_id`);

--
-- Index pour la table `tbl__17inscription__des__eleves`
--
ALTER TABLE `tbl__17inscription__des__eleves`
  ADD PRIMARY KEY (`inscription__des__eleves_id`);

--
-- Index pour la table `tbl__18gestion__des__cotes`
--
ALTER TABLE `tbl__18gestion__des__cotes`
  ADD PRIMARY KEY (`gestion__des__cotes_id`);

--
-- Index pour la table `tbl__19qualification__grade`
--
ALTER TABLE `tbl__19qualification__grade`
  ADD PRIMARY KEY (`qualification__grade_id`);

--
-- Index pour la table `tbl__20option`
--
ALTER TABLE `tbl__20option`
  ADD PRIMARY KEY (`option_id`);

--
-- Index pour la table `tbl__21extra__utilisateur`
--
ALTER TABLE `tbl__21extra__utilisateur`
  ADD PRIMARY KEY (`user_id`);

--
-- Index pour la table `tbl__22frais__scolaire`
--
ALTER TABLE `tbl__22frais__scolaire`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__23caisse`
--
ALTER TABLE `tbl__23caisse`
  ADD PRIMARY KEY (`caisse_id`);

--
-- Index pour la table `tbl__24banque`
--
ALTER TABLE `tbl__24banque`
  ADD PRIMARY KEY (`banque_id`);

--
-- Index pour la table `tbl__25type__de__compte`
--
ALTER TABLE `tbl__25type__de__compte`
  ADD PRIMARY KEY (`type__de__compte_id`);

--
-- Index pour la table `tbl__26compte`
--
ALTER TABLE `tbl__26compte`
  ADD PRIMARY KEY (`compte_id`);

--
-- Index pour la table `tbl__27payer__les__frais`
--
ALTER TABLE `tbl__27payer__les__frais`
  ADD PRIMARY KEY (`payer__les__frais_id`);

--
-- Index pour la table `tbl__28recus`
--
ALTER TABLE `tbl__28recus`
  ADD PRIMARY KEY (`recus_id`);

--
-- Index pour la table `tbl__29sortie`
--
ALTER TABLE `tbl__29sortie`
  ADD PRIMARY KEY (`sortie_id`);

--
-- Index pour la table `tbl__30categorie`
--
ALTER TABLE `tbl__30categorie`
  ADD PRIMARY KEY (`categorie_id`);

--
-- Index pour la table `tbl__31perception__des__frais`
--
ALTER TABLE `tbl__31perception__des__frais`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__32solvabilite`
--
ALTER TABLE `tbl__32solvabilite`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__33entree`
--
ALTER TABLE `tbl__33entree`
  ADD PRIMARY KEY (`entree_id`);

--
-- Index pour la table `tbl__34journal__caisse__ou__banque`
--
ALTER TABLE `tbl__34journal__caisse__ou__banque`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__35transfert`
--
ALTER TABLE `tbl__35transfert`
  ADD PRIMARY KEY (`transfert_id`);

--
-- Index pour la table `tbl__36liste__eleve`
--
ALTER TABLE `tbl__36liste__eleve`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__37point_eleve`
--
ALTER TABLE `tbl__37point_eleve`
  ADD PRIMARY KEY (`point_eleve_id`);

--
-- Index pour la table `tbl__38bulletins`
--
ALTER TABLE `tbl__38bulletins`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__39multiple__encodage__cours`
--
ALTER TABLE `tbl__39multiple__encodage__cours`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__40configuration__de__cours`
--
ALTER TABLE `tbl__40configuration__de__cours`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `tbl__41periodicite`
--
ALTER TABLE `tbl__41periodicite`
  ADD PRIMARY KEY (`periodecite_id`);

--
-- Index pour la table `tbl__42activites`
--
ALTER TABLE `tbl__42activites`
  ADD PRIMARY KEY (`activite_id`);

--
-- Index pour la table `tbl__43branches`
--
ALTER TABLE `tbl__43branches`
...
--
-- AUTO_INCREMENT pour la table `tbl__01foreign__keys`
--
ALTER TABLE `tbl__01foreign__keys`
  MODIFY `fk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT pour la table `tbl__02utilisateurs`
--
ALTER TABLE `tbl__02utilisateurs`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT pour la table `tbl__03configuration`
--
ALTER TABLE `tbl__03configuration`
  MODIFY `config_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `tbl__04customize__tabform`
--
ALTER TABLE `tbl__04customize__tabform`
  MODIFY `tabform_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__05table__fields`
--
ALTER TABLE `tbl__05table__fields`
  MODIFY `table__field_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__06input__objects`
--
ALTER TABLE `tbl__06input__objects`
  MODIFY `input__object_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT pour la table `tbl__07dropdownlist`
--
ALTER TABLE `tbl__07dropdownlist`
  MODIFY `dropdownlist_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__08dropdownlist__group`
--
ALTER TABLE `tbl__08dropdownlist__group`
  MODIFY `dropdownlistgroup_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__09type__de__gestion`
--
ALTER TABLE `tbl__09type__de__gestion`
  MODIFY `type__de__gestion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `tbl__10institution`
--
ALTER TABLE `tbl__10institution`
  MODIFY `institution_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT pour la table `tbl__11section`
--
ALTER TABLE `tbl__11section`
  MODIFY `section_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `tbl__12enseignants`
--
ALTER TABLE `tbl__12enseignants`
  MODIFY `enseignant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT pour la table `tbl__13cours`
--
ALTER TABLE `tbl__13cours`
  MODIFY `cours_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
--
-- AUTO_INCREMENT pour la table `tbl__14frais__scolaires`
--
ALTER TABLE `tbl__14frais__scolaires`
  MODIFY `frais__scolaires_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT pour la table `tbl__15classe`
--
ALTER TABLE `tbl__15classe`
  MODIFY `classe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT pour la table `tbl__16conduite`
--
ALTER TABLE `tbl__16conduite`
  MODIFY `conduite_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT pour la table `tbl__17inscription__des__eleves`
--
ALTER TABLE `tbl__17inscription__des__eleves`
  MODIFY `inscription__des__eleves_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=682;
--
-- AUTO_INCREMENT pour la table `tbl__18gestion__des__cotes`
--
ALTER TABLE `tbl__18gestion__des__cotes`
  MODIFY `gestion__des__cotes_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__19qualification__grade`
--
ALTER TABLE `tbl__19qualification__grade`
  MODIFY `qualification__grade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `tbl__20option`
--
ALTER TABLE `tbl__20option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `tbl__21extra__utilisateur`
--
ALTER TABLE `tbl__21extra__utilisateur`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `tbl__22frais__scolaire`
--
ALTER TABLE `tbl__22frais__scolaire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__23caisse`
--
ALTER TABLE `tbl__23caisse`
  MODIFY `caisse_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `tbl__24banque`
--
ALTER TABLE `tbl__24banque`
  MODIFY `banque_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `tbl__25type__de__compte`
--
ALTER TABLE `tbl__25type__de__compte`
  MODIFY `type__de__compte_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pour la table `tbl__26compte`
--
ALTER TABLE `tbl__26compte`
  MODIFY `compte_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `tbl__27payer__les__frais`
--
ALTER TABLE `tbl__27payer__les__frais`
  MODIFY `payer__les__frais_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT pour la table `tbl__28recus`
--
ALTER TABLE `tbl__28recus`
  MODIFY `recus_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `tbl__29sortie`
--
ALTER TABLE `tbl__29sortie`
  MODIFY `sortie_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT pour la table `tbl__30categorie`
--
ALTER TABLE `tbl__30categorie`
  MODIFY `categorie_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT pour la table `tbl__31perception__des__frais`
--
ALTER TABLE `tbl__31perception__des__frais`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__32solvabilite`
--
ALTER TABLE `tbl__32solvabilite`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__33entree`
--
ALTER TABLE `tbl__33entree`
  MODIFY `entree_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `tbl__34journal__caisse__ou__banque`
--
ALTER TABLE `tbl__34journal__caisse__ou__banque`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__35transfert`
--
ALTER TABLE `tbl__35transfert`
  MODIFY `transfert_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__36liste__eleve`
--
ALTER TABLE `tbl__36liste__eleve`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__37point_eleve`
--
ALTER TABLE `tbl__37point_eleve`
  MODIFY `point_eleve_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
--
-- AUTO_INCREMENT pour la table `tbl__38bulletins`
--
ALTER TABLE `tbl__38bulletins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__39multiple__encodage__cours`
--
ALTER TABLE `tbl__39multiple__encodage__cours`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__40configuration__de__cours`
--
ALTER TABLE `tbl__40configuration__de__cours`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `tbl__41periodicite`
--
ALTER TABLE `tbl__41periodicite`
  MODIFY `periodecite_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT pour la table `tbl__42activites`
--
ALTER TABLE `tbl__42activites`
  MODIFY `activite_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT pour la table `tbl__43branches`
--
ALTER TABLE `tbl__43branches`
  MODIFY `branche_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;COMMIT;
