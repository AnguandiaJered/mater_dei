...
$orientation='L';
$output=fee_rpt($db,'tbl__27payer__les__frais',$ref,$feeid,$classeid,$from,$to);
include("../mpdf.php");
...
$mpdf->WriteHTML(header_top($db,'Rapport de perception de frais',$annee_scolaire).$output,2);
