...
<iframe src="texteffect/index.html" frameborder="0" style="position:absolute;"></iframe>
                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-scroll dropdown-messages">
                            ...
                            <li class="dropdown-header">
                                <i class="fa fa-envelope"></i>PAS DISPO
                            </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-scroll dropdown-alerts">
                            ...
                            <li class="dropdown-header">
                                <i class="fa fa-bell"></i> PAS DISPO
                            </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-scroll dropdown-tasks">
                            ...
                            <li class="dropdown-header">
                                <a href="eleve_gestion.php"><i class="fa fa-tasks"></i> GESTION DES ELEVES</a>
                            </li>
		...
		*/
		...
		{
		case'admin':
		$menusubmenu_array=array('0'=>'CONFIGURATION,3,40,2,9,10,11,20,19,12,39,14,15,16,23,24,25,26','1'=>'LISTE ELEVE,36','2'=>'GESTION DES COTES,18','3'=>'FINANCE,22,33,29,35','4'=>'RAPPORTS,31,32,34');
		break;
		case'enseignant':
		...
		break;
		case'reception':
		$menusubmenu_array=array('0'=>'INSCRIPTION ELEVE,17,36','1'=>'RAPPORTS,32');
		break;
		case 'financier':
		...
		break;
		case 'caissier_sortie':
		$menusubmenu_array=array('0'=>'SORTIE,29','1'=>'RAPPORTS,32,34');
		break;
		default:
		{
			$menusubmenu_array='';
...
<div class="row"><div class="col-lg-12">
						...
						switch(CL)
						{
							...
							{
							echo'
							<a href="retrieve/?class=17&action=default&ref_id=default&ref_menu=default"><button type="button" class="btn btn-success">Affichage donnees</button></a>
							<iframe src="inscription_eleve.php?class=17&action='.AC.'&ref_id='.ID.'&ref_menu=default" width="100%" height="800px;" frameborder="0"></iframe>';	
							#echo $form->dynamic_form_middle($db,$table,$form_header,$form_middle,$form_footer,$input,$css_class,$dropdown_list);
							}
							break;
							case 18:
							...
							break;
							case 31:
							if($_SESSION['DESIGNATION']=='directeur'||$_SESSION['DESIGNATION']=='financier'||$_SESSION['DESIGNATION']=='caissier_entree')
							{
							echo '<iframe src="rapport_perception_des_frais.php" width="100%" height="800px;" frameborder="0"></iframe>';
							break;
							}
							case 32:
							if($_SESSION['DESIGNATION']=='directeur'||$_SESSION['DESIGNATION']=='financier'||$_SESSION['DESIGNATION']=='reception'||$_SESSION['DESIGNATION']=='caissier_entree'||$_SESSION['DESIGNATION']=='caissier_sortie')
							{
							...
							break;
							case 34:
							if($_SESSION['DESIGNATION']=='directeur'||$_SESSION['DESIGNATION']=='financier'||$_SESSION['DESIGNATION']=='caissier_entree'||$_SESSION['DESIGNATION']=='caissier_sortie')
							{
