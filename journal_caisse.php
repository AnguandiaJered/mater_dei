...
<tr>
<td><label>Du</label>  <input type="text" id="from" name="from" class="tcal"/> <label>Au</label>  <input type="text" name="to" id="to" class="tcal"/></td>
<td><select id="treasure_or_bankId" onchange="return show_bank_or_treasure(this);">
...
<td><button onclick="generate_rpt('from','to','treasure_or_bankId','caisse_bank_Id');">Generer rapport</button></td>
</tr>
